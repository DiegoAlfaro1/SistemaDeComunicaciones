...
string Operator::toString() const{
    ostringstream str;
    str << "Operator id: " << id << ", Tiempo total de llamada: "<< totalSpentTalkingTime << ", total de mensajes enviados: "<< 
    totalMessageSent << ", total de uso de internet: "<< totalInternetUsage;
